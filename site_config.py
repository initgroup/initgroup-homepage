...
PAGES = (
    ...
    Page(
        ...
        title="인뎁스 IN-DEPS | 설명 가능한 데이터 품질 플랫폼",
        description="INIT-Data Editing Platform System의 약자인 인뎁스 IN-DEPS가 데이터 구조와 관계를 분석해 설명 가능한 품질 규칙을 발굴하고 위반 탐지·전문가 검토·수정·실행 이력을 관리하는 과정을 소개합니다.",
        nav_key="solutions",
        og_title="인뎁스 IN-DEPS | 인아이티",
